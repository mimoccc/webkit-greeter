(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      template: "{avatar}{user}<br />{text}{time} - {answer} - {open}", // [string or function] template used to construct each tweet <li> - see code for available vars
      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          var tweets = $.map(data.results || data, function(item){
            ...
            var reply = "http://twitter.com/home?status=@"+screen_name;
			...
			var answer = '<a class="tweet_answer" href="'+reply+'">Antworten</a>';
			var open = '<a class="tweet_open" href="'+tweet_url+'">Tweet aufrufen</a>';
